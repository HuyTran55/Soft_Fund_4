...
public class Person {
    ...
    public boolean addPerson () {
        ...
        // ! Condition 1: PersonID should be exactly 10 characters long; I/the first two characters should be numbers between 2 and 9, there should be at least two special characters between characters 3 and 8,
